...
var interval = setInterval(function() {
    ...
    var timeUntilNextBellWMC = (("0" + (Math.floor((h_1%1)*24))).slice(-2)+":"+("0" + Math.floor((m_2%1)*60)).slice(-2)+":"+("0" + Math.floor((s_3%1)*60)).slice(-2));
    timer.innerText = timeUntilNextBellWMC;
}, 500);
